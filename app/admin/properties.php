        ...
        <form id="addnewpropertyform">
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                <tr>
                  <th><input type="text" name="propertyidbyadmin" class="border-0 py-0 form-control" placeholder="1.1" required /></th>
                  <td>
                    <input type="number" name="price" class="border-0 py-0 form-control" placeholder="$1,490,000" required />
                  </td>
                  <td>
                    <input type="number" name="beds" class="border-0 py-0 form-control" placeholder="3 BED" required />
                  </td>
                  <td>
                    <input type="number" name="baths" class="border-0 py-0 form-control" placeholder="2 BATH" required />
                  </td>
                  <td>
                    <input type="number" name="cars" class="border-0 py-0 form-control" placeholder="1" required />
                  </td>
                  <td>
                    <input type="number" name="car_lots" class="border-0 py-0 form-control" placeholder="1" required />
                  </td>
                  <td>
                    <input type="number" name="storage_lots" class="border-0 py-0 form-control" placeholder="1" required />
                  </td>
                  <td>
                    <input type="number" name="level1" class="border-0 py-0 form-control" placeholder="1" required />
                  </td>
                  <td>
                    <input type="number" name="aspect" class="border-0 py-0 form-control" placeholder="" required />
                  </td>
                  <td>
                    <input type="number" name="total_area" class="border-0 py-0 form-control" placeholder="184m2" required />
                  </td>
                  <td>
                    <input type="number" name="internal_area" class="border-0 py-0 form-control" placeholder="184m2" required />
                  </td>
                  <td>
                    <input type="number" name="external_area" class="border-0 py-0 form-control" placeholder="184m2" required />
                  </td>
                  <td>
